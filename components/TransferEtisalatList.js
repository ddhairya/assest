...
import TransferHistory from "../screens/transferHistroy";
 ...
 const TransferEtisalatList = ({netwrk,transferDevice, category}) => {
    ...
    return(
        <View>
            ...
            <Modal visible={transferDeviceModalOpen}>
                <TransferDevice transferDevice={transferDevice} setTransferDeviceModalOpen={setTransferDeviceModalOpen} device={netwrk} />
            </Modal>
            <Modal visible={transferHistModalOpen}>
                <TransferHistory category={category}  setTransferHistModalOpen={setTransferHistModalOpen} device={netwrk} />
            </Modal>           
        </View>
    )
}
...
export default TransferEtisalatList;