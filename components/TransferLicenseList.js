...
import TransferHistory from "../screens/transferHistroy";
 ...
 const TransferLicenseList = ({lic, transferDevice, category}) => {
    ...
    return(
        <View>
            ...
            <Modal visible={transferDeviceModalOpen}>
                <TransferDevice transferDevice={transferDevice} setTransferDeviceModalOpen={setTransferDeviceModalOpen} device={lic} />
            </Modal>
            <Modal visible={transferHistModalOpen}>
                <TransferHistory category={category}  setTransferHistModalOpen={setTransferHistModalOpen} device={lic} />
            </Modal>           
        </View>
    )
}
...
export default TransferLicenseList;